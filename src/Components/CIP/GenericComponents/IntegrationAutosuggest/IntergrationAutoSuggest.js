...
class IntergrationAutoSuggest extends React.Component {
...
IntergrationAutoSuggest.propTypes = {
...
export default connect(mapStateToProps)(withStyles(styles)(IntergrationAutoSuggest));
